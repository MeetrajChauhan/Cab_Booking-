...
module.exports.createRide = async ({
  ...
  try {
    ...
    // Full fare shown to user
    const fullFare = fare[vehicleType];

    // Commission split: 90% to captain, 10% to admin
    const driverFare = Math.round(fullFare * 0.9);
    const adminCommission = fullFare - driverFare;
